                ...
                <div className="ha-container">
                    <div className="columns">
                        ...
                        <div className="ha-content " style={{marginLeft: '25px'}}>
                            ...
                            <p style={{fontSize: '20px',  fontWeight: '700' , color: 'white'}}> Экскурсии для школьников, каждая поездка имеет свой смысл. Некоторые экскурсии рассчитаны на общее развитие школьников, помогают углубленно изучить определенную тему, а другие доставят приятное времяпрепровождение и приятные ощущения</p>
